...
class LoginFrame(Frame):
    ...
    def create_widgets(self):
        ...
        self.username_label = Label(self.username_frame, text="Username:", font=("Helvetica", 16), bg="#F3F1EB", fg="#4C4A46")
        ...
        self.user_entry.grid(row=1, column=0, sticky='ew', pady=10)
        ...
        self.pass_label = Label(self.pass_frame, text="Password:", font=("Helvetica", 16), bg="#F3F1EB", fg="#4C4A46")
        ...
        self.pass_entry.grid(row=1, column=0, sticky='ew', pady=10)
